<template>
  <div class="admin-layout">
    <aside class="sidebar glass-panel" :class="{ 'sidebar-open': isSidebarOpen }">
      ...
      <nav class="admin-nav">
        <router-link to="/admin/dashboard" class="nav-item" @click="isSidebarOpen = false">
          <span class="nav-icon">
        ...
        <router-link to="/admin/requests" class="nav-item" @click="isSidebarOpen = false">
          <span class="nav-icon">
        ...
        <router-link to="/admin/contracts" class="nav-item" @click="isSidebarOpen = false">
          <span class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
          </span>
          <span class="nav-label">Huurcontract sjabloon</span>
        </router-link>
      ...
      <div class="sidebar-footer">
        <button @click="handleLogout" class="logout-btn neo-btn neo-btn-outline">
          <span class="btn-icon">
...
.nav-item:hover {
  background: rgba(124, 58, 237, 0.05); /* Using var equivalent */
